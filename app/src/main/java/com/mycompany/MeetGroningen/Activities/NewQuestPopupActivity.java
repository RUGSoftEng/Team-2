...
public class NewQuestPopupActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button ownQuest = (Button) findViewById(R.id.ownQuestButton); //the button for creating one's own quest
        Button existingQuest = (Button) findViewById(R.id.existingQuestButton); //the button for picking an existing quest
        Button makeLandmarkButton = (Button) findViewById(R.id.makeLandmarkButton);
