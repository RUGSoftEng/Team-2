...
*/
        ...
        essentailQuest.addLandmark(cityHall);
        essentailQuest.addLandmark(korenbeurs);
 /*       essentailQuest.addLandmark(synagogue);
        essentailQuest.addLandmark(gronigerMuseum);
        essentailQuest.addLandmark(station);
        essentailQuest.addLandmark(peerd);
        essentailQuest.addLandmark(aKerk);
        */
        essentailQuest.addLandmark(academieGebouw);
        essentailQuest.addLandmark(goudKantoor);
