...
public class QuestPreviewActivity extends FragmentActivity implements
    ...
    /** A request code to send to Google Play Services, which is returned in Activity.onActivityResult. */
    ...
    /**
     * Is called whenever the current user's location changes, itself calling handleNewLocation to handle the updated location.
     *
     * @param location The new location.
     */
    @Override
