...
public class LandMarkPopUpActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(rugse.team2.MeetGroningen.R.layout.landmark_popup_window);
        ...
        TextView textInfo = (TextView) findViewById(rugse.team2.MeetGroningen.R.id.textView4);
        textInfo.setMovementMethod(new ScrollingMovementMethod());
        textInfo.setText(passedLandmark.getInformation());

        Button nextLandmarkButton = (Button) findViewById(rugse.team2.MeetGroningen.R.id.nextLandmarkButton);
        ...
        quizButton = (Button) findViewById(rugse.team2.MeetGroningen.R.id.quizButton);
